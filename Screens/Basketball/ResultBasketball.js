...
let pScoreBasketball =route.params.dataBasketball;
  ...
  return(
    ...
    <Text style={{fontSize:20}}> Do you want to try again or choose another</Text> 
     ...
     <Text style={{fontSize:20,fontWeight:'bold', marginBottom:20}}> Your Total Score is =  {pScoreBasketball} out of 20 points</Text>
