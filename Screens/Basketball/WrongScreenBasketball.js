...
export default function WrongScreenBasketball(props) {
  const route = useRoute()
    const PScreenNameBasketball= route.params.data2
    const PScoreBasketball= parseInt(route.params.datawBasketball)
    return (
  ...
  backgroundColor:"pink" }}  onPress= {()=>{props.navigation.navigate(PScreenNameBasketball, {data1:PScoreBasketball})}}
