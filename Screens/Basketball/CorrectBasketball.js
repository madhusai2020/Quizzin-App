...
export default function CorrectBasketball(props) {
    const route = useRoute()
    const PScreenNameBasketball= route.params.data2
    const PScoreBasketball= parseInt(route.params.datacBasketball)
    return (
...
onPress={()=>props.navigation.navigate(PScreenNameBasketball, {data1:PScoreBasketball})}
>
