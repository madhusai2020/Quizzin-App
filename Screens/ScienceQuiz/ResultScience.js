...
let pScoreScience =route.params.dataScience;
  
  return(
    <View style={{flex:1, marginBottom:10, justifyContent:'center', alignItems:'center', backgroundColor:'#FF00FF'}}>
    ...
    <Text style={{fontSize:20, marginBottom:20, fontWeight:'bold', marginTop:50}}> Congrats on finishing the quiz!</Text>
     ...
     <Text style={{fontSize:20,fontWeight:'bold', marginBottom:50, marginTop:50}}> Your Total Score is = {pScoreScience} out of 40 points.!</Text>
