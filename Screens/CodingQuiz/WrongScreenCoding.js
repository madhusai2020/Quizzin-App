...
export default function WrongScreenCoding(props) {
  const route = useRoute()
    const PScreenNameCoding= route.params.data2
    const PScoreCoding= parseInt(route.params.datawCoding)
    return (
  ...
  backgroundColor:"pink" }}  onPress= {()=>{props.navigation.navigate(PScreenNameCoding, {data1:PScoreCoding})}}
