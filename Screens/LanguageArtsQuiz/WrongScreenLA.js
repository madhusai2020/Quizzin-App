...
export default function WrongScreenLA(props) {
  const route = useRoute()
    const PScreenNameLA= route.params.data2
    const PScoreLA= parseInt(route.params.datawLA)
    return (
  ...
  backgroundColor:"pink" }}  onPress= {()=>{props.navigation.navigate(PScreenNameLA, {data1:PScoreLA})}}
