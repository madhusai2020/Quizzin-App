...
export default function CorrectLA(props) {
    ...
    const PScreenNameLA= route.params.data2
     const PScoreLA= parseInt(route.params.datacLA)
    return (
        <View style={{backgroundColor:"lime", flex:1, alignItems:"center", justifyContent:"center"}}>
            <Text style={{fontSize:50, color:"black", marginBottom:100}}> Correct answer!</Text>
...
onPress={()=>props.navigation.navigate(PScreenNameLA, {data1:PScoreLA})}
>
